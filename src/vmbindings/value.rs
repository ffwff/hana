...
impl Value {
    ...
    pub fn wrap(&self) -> NativeValue {
        ...
        unsafe { match &self {
            ...
            Value::NativeFn(n) => NativeValue { r#type: _valueType::TYPE_NATIVE_FN,
                                                data: transmute::<NativeFnData, u64>(*n) },
            Value::Fn(_)       => NativeValue { r#type: _valueType::TYPE_FN, data: 0        },
            Value::Str(s)      => NativeValue { r#type: _valueType::TYPE_STR, data: 0       },
